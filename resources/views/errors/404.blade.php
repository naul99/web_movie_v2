...
<body>
    ...
    <svg id="yetiSVG" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 600 470">
        ...
        <g id="yeti">
            ...
            <g>
                ...
                <ellipse cx="85.8" cy="120.4" fill="none" stroke="#265D85" stroke-width="2.5"
                    rx="11.5" ry="11.5" transform="rotate(-66.265 85.7992 120.4318)" />
            ...
            <g id="armR">
                ...
                <path fill="none" stroke="#265D85" stroke-linecap="round" stroke-linejoin="round"
                    stroke-miterlimit="10" stroke-width="2.5" d="M162.3 128.6l18.6 46.7 37.2-14.8-15.3-38.3" />
                ...
                <path fill="none" stroke="#265D85" stroke-linecap="round" stroke-linejoin="round"
                    stroke-miterlimit="10" stroke-width="2.5" d="M203.5 123.8l-1.5-3.7c-2-5.1-7.9-7.6-13-5.6" />
                <path fill="none" stroke="#265D85" stroke-linecap="round" stroke-linejoin="round"
                    stroke-miterlimit="10" stroke-width="2.5" d="M193.7 126.4l-4.4-11.1c-2-5.1-7.9-7.6-13-5.6" />
                <path fill="#67B1E0"
                ...
                <path fill="none" stroke="#265D85" stroke-linecap="round" stroke-linejoin="round"
                    stroke-miterlimit="10" stroke-width="2.5" d="M181.5 122.7L180 119c-2-5.1-7.9-7.6-13-5.6" />
                <path fill="none" stroke="#265D85" stroke-linecap="round" stroke-linejoin="round"
                    stroke-miterlimit="10" stroke-width="2.5" d="M172.2 126.4l-1.5-3.7c-2-5.1-7.9-7.6-13-5.6" />
            </g>
            <g id="armL">
                <path fill="#67B1E0"
    ...
    <div class="content">
        <h3>Xin chào?? Là ai đó?!?</h3>
        <p>Chúng tôi biết điều đó thật đáng sợ nhưng không thể tìm thấy trang bạn đang cố truy cập. Có lẽ đó chỉ là một
            giấc mơ
            <span>link</span> xấu?
        </p>
        <button class="btn green"><a style="text-decoration: none;" href="{{ route('homepage') }}">Quay lại!</a></button>
    </div>

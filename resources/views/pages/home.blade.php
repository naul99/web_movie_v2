            ...
            <section id="browse-dashboard" class=" d-flex direction-column flex-start middle-align">
                <div>
                    ...
                    <video class="hero-background-image" id="hero-video"
                        poster="https://img.ophim10.cc/uploads/movies/ngoi-truong-xac-song-poster.jpg">
                        <source src="https://youtu.be/4dAaLbsQSzI?si=XGIhVgWH2JkhqXZ0"
                            type="video/mp4">
                ...
                <section id="continue-watching" class="container p-t-40">
                    ...
                    <div class="continue-watching-container d-flex flex-start flex-middle flex-no-wrap owl-carousel">
                        @foreach ($cate_home->movie->sortBydesc('updated_at')->take(8) as $key => $mov)
                            <div class="video">
                                <video height="350px" width="350px" class="mylist-img p-r-10 p-t-10 video-item"
                                    poster="
                                    @php
$image_check = substr($mov->movie_image->image, 0, 5); @endphp
            ...
            <section class="big-section d-flex flex-start container">
                ...
                <div class="right-side">
                    <div class="contentlogo">
                        <img src="https://img.ophim10.cc/uploads/movies/ngoi-truong-xac-song-poster.jpg" alt="content logo"
                            class="show-logo" />
                    </div>
